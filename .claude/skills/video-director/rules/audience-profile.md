...
Retention patterns are defined in [narration-writing.md](narration-writing.md) under "Retention Patterns." Key techniques:
- **Forward hooks**: End content scenes with a tease of the next section (1 per section)
- **Re-hook at 60% mark**: Stronger narration beat to combat mid-video retention valley
- **Energy oscillation**: Calm-burst pattern every 4-6 scenes

These patterns complement the engagement psychology above. The narration rules file is the source of truth for implementation.
