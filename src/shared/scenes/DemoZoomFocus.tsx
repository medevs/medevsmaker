          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            >
              ...
              <div style={{ display: "flex", gap: 30 }}>
                <div>
                  <div style={{ fontFamily: fontFamily, fontSize: Math.round(32 * fontScale), fontWeight: 700, color: accent }}>
                    2,847
                  </div>
                  {/* intentional: simulates dashboard UI label */}
                  <div style={{ fontFamily: fontFamily, fontSize: Math.round(12 * fontScale), color: colors.muted }}>
                    Active Users
                  </div>
                </div>
                <div>
                  <div style={{ fontFamily: fontFamily, fontSize: Math.round(32 * fontScale), fontWeight: 700, color: BRAND.green }}>
                    +12.5%
                  </div>
                  {/* intentional: simulates dashboard UI label */}
                  <div style={{ fontFamily: fontFamily, fontSize: Math.round(12 * fontScale), color: colors.muted }}>
