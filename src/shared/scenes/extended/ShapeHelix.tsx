    ...
    <AbsoluteFill style={{ background: BRAND.bg, perspective: 800 }}>
      ...
      >
        {Array.from({ length: points }).map((_, i) => {
          ...
          const delay = i * 2;
          const pointProgress = interpolate(frame, [startDelay + delay, startDelay + delay + 15], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: Easing.bezier(0.16, 1, 0.3, 1) });
            ...
            <React.Fragment key={`helix-${i}`}>
              ...
              <div
                style={{
                  ...
                  boxShadow: `0 0 20px ${BRAND.violet}`,
                }}
              />
              {/* 接続線（簡略化） */}
              <div
