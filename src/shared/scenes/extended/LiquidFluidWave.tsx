    ...
    <AbsoluteFill style={{ background: `linear-gradient(180deg, ${sc.bg} 0%, ${BRAND.bgLight} 100%)` }}>
      ...
      <div
        style={{
          ...
          left: "50%",
          top: "20%",
          transform: `translate(-50%, -50%) scale(${interpolate(frame, [startDelay + 20, startDelay + 40], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: Easing.bezier(0.34, 1.56, 0.64, 1) })})`,
          fontFamily,
          fontSize: 120,
          fontWeight: 900,
          color: sc.text,
