      ...
      >
        {showFinal ? (
          ...
          <div
            style={{
              fontFamily,
              fontSize: Math.round(100 * fontScale) + launchProgress * Math.round(20 * fontScale),
              fontWeight: 900,
              color: "#ff6b6b",
              ...
              {isCountdown ? (
                ...
                <>
                  <div
                    style={{
                      fontFamily,
                      fontSize: Math.round(180 * fontScale),
                      fontWeight: 900,
                      color: colors.text,
                      height: wordHeight,
                      display: "flex",
